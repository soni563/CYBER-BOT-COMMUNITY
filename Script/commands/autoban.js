...
module.exports.handleEvent = async ({
	...
	var h = {
		body: `»Notice from Owner Sonu«\n\n${c}, You are stupid for cursing bots so bots automatically banned you from the system`
	};
    //Add curse words without capital letters
	["bot mc", "Mc bot", "Chutiya bot", "Bsdk bot", "Bot tmkc", "Jhatu bot", "lol bot", "stupid bots", "Lol bot", "Bot lund", "Sonu mc", "Mc ullash", "Bsdk priyansh", "fuck bots", "ullash chutiya", "bekar bot", "Bekar bot", "crazy bots", "bc bot", "Nikal bsdk bot"].forEach((a => {
